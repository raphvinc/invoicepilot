  ...
  return (
    <div>
      <div className="mb-8 flex justify-between items-center">
        ...
        <button
          className="bg-indigo-600 text-white px-5 py-2.5 rounded-lg hover:bg-indigo-700 transition-colors shadow-sm flex items-center"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <select
              id="score"
              name="score"
              className="block w-full rounded-lg border-gray-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-colors duration-200"
            >
          ...
          <div>
            <label htmlFor="lastInvoice" className="block text-sm font-medium text-gray-700 mb-2">
              Dernière facture
            </label>
            <select
              id="lastInvoice"
